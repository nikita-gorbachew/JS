...
console.log(`Вы ввели ${num1}`);
let num2 = prompt('Введите num2');
console.log(`Вы ввели ${num2}`);
if (num1 <= 1) {
    console.log(`num1 <= 1`);
}
else if (num1 > 1) {
...
if (num >= 0) {
    ...
    console.log(`В числе ${num} количество тысяч: ${Math.trunc(thousands)}, сотен: ${Math.trunc(hundreds)}, десятков: ${Math.trunc(tens)}, единиц: ${Math.trunc(units)}`);
}
